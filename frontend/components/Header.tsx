...
//       {/* Top Info Bar */}
//       <div className="flex justify-center items-center h-13 text-sm border-b border-gray-100">
//         <div className="flex gap-x-50 max-w-screen-xl w-full px-4">
//           <Link
//             href="tel:0999999999"
...
//       {/* Main Navigation */}
//       <nav
//         className={`bg-white shadow-sm h-20 transition-all duration-300 ${
//           isFixed ? "fixed top-0 left-0 w-full z-50 shadow-md" : ""
//         }`}
//       >
//         <div className="max-w-screen-xl mx-auto px-4 py-4 flex items-center justify-between h-full">
//           {/* Logo */}
